...
public class User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "DOB", "Gender", "Address", "Phn_no", "Email", "Utype", "Degree", "Religion"
            }
        ) {
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        txtPhnNo.setText(d.getValueAt(selectIndex, 5).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            pst = con.prepareStatement("UPDATE user SET name = ?, dob = ?, gender = ?, degree = ?, religion = ?, address = ?, phn_no = ?, email = ?, utype = ? WHERE ID = ?");
